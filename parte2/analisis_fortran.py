...
if __name__ == '__main__':
    ...
    # Hardcoded scipy results from analisis_coincidencias.py
    scipy_hardcoded = {
        '511_157':  {'x0': 78.05, 'sigma': 3.18, 'A': 541.4, 'area': 4310.4, 'bg': 37.6, 'c1': 0},
        '1274_157': {'x0': 196.45, 'sigma': 6.11, 'A': 69.6, 'area': 1066.1, 'bg': 0.3, 'c1': 0},
        '511_180':  {'x0': 78.39, 'sigma': 3.16, 'A': 6803.5, 'area': 53831.6, 'bg': 359.0, 'c1': -3.82},
        'pico_200': {'x0': 196.81, 'sigma': 5.12, 'A': 31.9, 'area': 408.6, 'bg': 1.4, 'c1': 0},
    }
    ...
    with open(os.path.join(OUT_DIR, 'resultados_fortran.json'), 'w') as f:
