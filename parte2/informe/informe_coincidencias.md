...
- Centro: $x_0 = 78.05 \pm 0.13$ canales
- Sigma: $\sigma = 3.18 \pm 0.13$ canales
- FWHM: $7.48 \pm 0.30$ canales
- Amplitud: $A = 541.4 \pm 25.0$
- Fondo constante: $b = 37.6 \pm 5.5$
- **Área:** $\mathrm{Area} = 4310.4 \pm 264.8$
- $\chi^2/\nu = 5.14$, $\nu = 21$, $R^2 = 0.9872$
...
- Centro: $x_0 = 196.45 \pm 0.25$ canales
- Sigma: $\sigma = 6.11 \pm 0.54$ canales
- FWHM: $14.39 \pm 1.26$ canales
- Amplitud: $A = 69.6 \pm 4.1$
- Fondo constante: $b = 0.3 \pm 4.2$
- **Área:** $\mathrm{Area} = 1066.1 \pm 112.5$
- $\chi^2/\nu = 0.92$, $\nu = 19$, $R^2 = 0.9368$
...
$$N_{511+1274} = N_{511} + N_{1274} = 4310.4 + 1066.1 \approx 5376.5$$

$$N_{acc} = N_{\text{total}} - N_{511+1274} = 16873 - 5376.5 = 11496.5$$

$N_{acc}$ incluye coincidencias accidentales (511+511 de dos desintegraciones
distintas), eventos de fondo Compton y otras coincidencias no deseadas.
...
- Centro: $x_0 = 78.39 \pm 0.01$ canales
- Sigma: $\sigma = 3.16 \pm 0.01$ canales
- FWHM: $7.43 \pm 0.03$ canales
- Amplitud: $A = 6803.5 \pm 34.2$
- Fondo lineal: $c_0 = 359.0 \pm 21.0$, $c_1 = -3.8155 \pm 0.2372$
- **Área:** $\mathrm{Area} = 53831.6 \pm 328.8$
- $\chi^2/\nu = 0.86$, $\nu = 22$, $R^2 = 0.9999$
...
$$R = \frac{11496.5}{53831.6} = 0.213564 \approx 2.14e-01$$
...
|------|:-------------:|:-----------------:|:------------:|:--------:|:----:|:---:|:--------------:|:----:|
| 511 keV (157°) | 78.05±0.13 | 3.18±0.13 | 7.48±0.30 | 541±25 | 37.6±5.5 | 4310±265 | 5.14 | 0.9872 |
| 1274 keV (157°) | 196.45±0.25 | 6.11±0.54 | 14.39±1.26 | 70±4 | 0.3±4.2 | 1066±112 | 0.92 | 0.9368 |
| 511 keV (180°) | 78.39±0.01 | 3.16±0.01 | 7.43±0.03 | 6803±34 | 359.0±21.0 | 53832±329 | 0.86 | 0.9999 |

### 7.2 Áreas y ratios

| Cantidad | Valor |
|----------|:-----:|
| Área pico 511 keV (157°, 511+1274) | 4310.4 ± 264.8 |
| Área pico 1274 keV (157°, 511+1274) | 1066.1 ± 112.5 |
| $N_{\text{511+1274}}$ total (157°) | 5376.5 |
| $N_{\text{total}}$ (157°) | 16873 |
| $N_{\text{acc}}$ (157°) | 11496.5 |
| Área pico 511 keV (180°, 511+511) | 53831.6 ± 328.8 |
| $R = N_{\text{acc}} / N_{511+511}$ | 0.213564 |
...
3. **Coincidencias accidentales:** $R = 0.2136 = 21.36%$ de las cuentas totales
