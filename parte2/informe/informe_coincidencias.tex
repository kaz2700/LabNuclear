...
gaussianos.
Se determin\'o la relaci\'on $R = N_{\text{acc}}(157^\circ)/N_{511+511}(180^\circ) = 0.253$,
...
Se define:
\begin{itemize}
  \item $N_{\text{total}}(157^\circ)$: n\'umero total de cuentas en el espectro a 157$^\circ$.
  \item $N_{511+1274}$: \'area total de los picos de 511 y 1274\,keV (coincidencias reales).
  \item $N_{\text{acc}}$: cuentas que no corresponden a coincidencias reales.
\end{itemize}
\begin{equation}
N_{\text{acc}}(157^\circ) = N_{\text{total}}(157^\circ) - N_{511+1274}
\end{equation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../graficos/22Na_157_completo.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/22Na_157_pico_511_1274.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/22Na_157_pico_1274.png}
...
Las coincidencias accidentales ($N_{\text{acc}} = 12576$) constituyen la mayor parte
de las cuentas totales. Incluyen:
\begin{itemize}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../graficos/22Na_180_completo.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/22Na_180_pico_511_511.png}
...
\begin{equation}
R = \frac{N_{\text{acc}}(157^\circ)}{N_{511+511}(180^\circ)} = \frac{12576}{49659} = 0.253
\end{equation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/22Na_comparacion.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/CoF_vs_FF.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../graficos/Co60_caracterizacion_completo.png}
...
Desviaci\'on $\sigma$ (canal) & $4.60 \pm 0.13$ & $5.29 \pm 0.27$ \\
FWHM (canal) & $10.83 \pm 0.31$ & $12.47 \pm 0.64$ \\
Amplitud $A$ & $6589 \pm 151$ & $5619 \pm 220$ \\
Fondo $c_0$ & $1598 \pm 72$ & $770 \pm 128$ \\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\textwidth]{../graficos/Co60_picos_caracterizacion.png}
\caption{Ajustes gaussianos de los picos de 1173\,keV, 1332\,keV y pico suma de $^{60}$Co.}
\label{fig:co60_picos}
\end{figure}

Calibraci\'on lineal obtenida:
\begin{equation}
E(\text{keV}) = (23.28 \pm 0.04) + (6.361 \pm 0.002) \times \text{canal}
\end{equation}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{../graficos/Co60_calibrado.png}
\caption{Espectro de $^{60}$Co calibrado en energ\'a. Las l\'ineas rojas se\~nalan las posiciones esperadas de 1173.2\,keV, 1332.5\,keV y 2505.7\,keV (pico suma).}
\label{fig:co60_calibrado}
\end{figure}

\subsection{Pico suma}

El pico suma (1173 + 1332 = 2505.7\,keV) se observa en canal $398.0 \pm 0.9$,
correspondiente a $2555 \pm 6$\,keV. La diferencia respecto al valor esperado se atribuye
a no linealidades en la respuesta del detector a altas energ\'as o a efectos de
apilamiento (pile-up) en el sistema de adquisici\'on.
...
\begin{itemize}
  \item $^{60}$Co (1173\,keV): $E_C = 209.8$\,keV $\rightarrow$ canal~29.
  \item $^{60}$Co (1332\,keV): $E_C = 214.4$\,keV $\rightarrow$ canal~30.
\end{itemize}
...
\begin{enumerate}
  ...
  \item \textbf{Coincidencias accidentales:} La relaci\'on $R = 0.253$ indica que
        aproximadamente el 25.3\% de las cuentas a 157$^\circ$ no provienen de la
        coincidencia real 511+1274. Esta fracci\'on incluye accidentales 511+511,
...
$^{22}$Na 157$^\circ$ --- Coincidencias reales & $N_{511+1274}$ & 4297 \\
$^{22}$Na 157$^\circ$ --- Coincidencias accidentales & $N_{\text{acc}}$ & 12576 \\
$^{22}$Na 180$^\circ$ --- Area 511+511\,keV & $N_{511+511}$ & 49659 \\
Relaci\'on de accidentales & $R$ & 0.253 \\
